            ...
            <nav>
              <ul className="navbar flex flex-col items-center justify-center space-y-5 text-center lg:flex-row lg:justify-start lg:space-x-10 lg:space-y-0">
                ...
                >
                  <button
                    type="button"
                    onClick={() => toggleSubMenu(setCompanySubMenuOpen, companySubMenuOpen)}
                ...
                {/* Products Sub-menu */}
                <NavigationMenu.List className={`submenu-item group relative ${!isMobile ? 'lg:hover:visible lg:group-hover:top-full lg:group-hover:opacity-100' : ''}`}>
                  <button
                    type="button"
                    onClick={() => toggleSubMenu(setProductsSubMenuOpen, productsSubMenuOpen)}
                    className="submenu-toggler inline-flex items-center justify-center text-center font-heading text-base text-dark-text hover:text-primary"
                  >
                    Products
                    <span className="pl-3">
                ...
                <NavigationMenu.List className={`submenu-item group relative ${!isMobile ? 'lg:hover:visible lg:group-hover:top-full lg:group-hover:opacity-100' : ''}`}>
                  <button
                    type="button"
                    onClick={() => toggleSubMenu(setResourcesSubMenuOpen, resourcesSubMenuOpen)}
                    className="submenu-toggler inline-flex items-center justify-center text-center font-heading text-base text-dark-text hover:text-primary"
                  >
                    Resources
                    <span className="pl-3">
