...
export default function Home() {
  ...
  return (
    <div className="overflow-hidden">
        ...
        <div className="px-4 xl:container">
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-3 lg:w-1/2">
              <div className="mx-auto mb-12 max-w-[530px] text-center lg:ml-0 lg:mb-0 lg:text-left">
                <h1
                  ...
                  data-wow-delay=".3s"
                >
                  <span className="inline-grid" data-aos="fade-left">
                ...
                <p
                  ...
                  data-wow-delay=".4s"
                >
                  Empower your business to thrive securely in the digital era.
                  Seamlessly secure, manage, and innovate across Operational
                  Technology (OT), information Technology (IT), and cloud
                  environments. Elevate your security posture while safeguarding
            ...
            <div className="w-full px-4 lg:w-1/2 relative">
              <div
                className="wow z-30 mx-auto w-full max-w-[700px] lg:ml-0 relative"
                style={{ paddingBottom: "56.25%" }}
              >
                <iframe
                  src="https://player.vimeo.com/video/995913472?badge=0&amp;autopause=0&amp;transparent=0&amp;player_id=0&amp;app_id=58479"
                  width="1280"
                  height="720"
                  frameBorder="0"
      ...
      {/* Denovo Core */}
      {/* <section className="bg-gradient-to-b to-[#4C458D] from-[#0C1A35] px-5 py-10 space-y-3">
        <>
          <h3 className="text-yellow-400 w-full text-center mt-2 text-4xl lg:text-5xl font-bold tracking-tight"></h3>
      ...
      {/* <section
        id="overview"
        className="py-10 sm:py-32 relative overflow-hidden"
      >
        <div className="absolute inset-0 bg-grad ient-to-r"></div>
        <div className="container mx-auto flex flex-col lg:flex-row items-center relative z-10">
          <div className="w-full lg:w-6/12 lg:pr-6 mb-6 lg:mb-0 text-center lg:text-left">
            ...
            <p
              className="text-xl lg:text-2xl leading-8 text-white mt-6"
              data-aos="fade-right"
            >
              Denovo Core Zero Trust is a comprehensive cybersecurity solution
              that provides a holistic approach to security. It is designed to
      ...
      {/* <section
        id="overview"
        className="bg-white py-10 sm:py-32 relative overflow-hidden"
      >
        <div className="container mx-auto flex flex-col lg:flex-row items-center">
          <div
            className="w-full lg:w-6/12 lg:pl-6 lg:pr-6 mb-6 lg:mb-0 "
            data-aos="fade-left"
          >
            <div className="relative overflow-hidden rounded-lg">
              <img
                src="./images/overview/homepage overview/dlpmain.drawio.png"
          ...
          <div className="w-full lg:w-6/12 lg:pr-6 mb-6 lg:mb-0">
            <h3 className="mt-2 text-4xl lg:text-4xl font-bold tracking-tight text-gray-900">
              Data Loss Prevention
            </h3>
            <div className="flex flex-col lg:flex-row items-center lg:items-start">
              <div className="lg:w-2/3 lg:pr-6">
                <p
                  className="text-xl lg:text-2xl leading-8 text-gray-700 mt-6 text-center lg:text-left"
                  data-aos="fade-right"
                >
                  Denovo Data Loss Prevention is a comprehensive solution that
                  helps you prevent data loss and protect sensitive information
                  from unauthorized access.
                </p>
                <div className="flex justify-center lg:justify-start mt-6">
                  <a
                    href="/products/data-loss-prevention"
                    className="inline-block bg-gray-200 text-blue-600 hover:bg-white hover:text-blue-800 font-semibold py-3 px-8 rounded-full transition duration-300"
                  >
                    Learn More
                  </a>
                </div>
      ...
      <section
        id="overview"
        className="bg-gray-200 py-10 sm:py-32 relative overflow-hidden"
      >
        <div className="container mx-auto flex flex-col lg:flex-row items-center">
          <div className="w-full lg:w-6/12 lg:pr-6 mb-6 lg:mb-0">
            <h3 className="mt-2 text-4xl lg:text-4xl font-bold tracking-tight text-gray-900">
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start mt-6">
              <div className="lg:w-2/3 lg:pr-6">
                <p
                  ...
                  data-aos="fade-right"
                >
                  Denovo AI Powered Threat Analysis uses machine learning
          ...
          <div className="w-full lg:w-6/12 lg:pl-6" data-aos="fade-left">
            <div className="relative overflow-hidden rounded-lg">
              <img
                src="./images/overview/homepage overview/AI POWERED.drawio.png"
                className="w-full object-cover"
                alt="AI Powered Threat Analysis"
              />
            </div>
          </div>
        </div>
